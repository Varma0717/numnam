            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  style: GoogleFonts.poppins(fontSize: 14),
                  decoration: _inputDecor('Confirm password', Icons.lock_outline),
                  validator: (v) {
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: widget.onToggle ?? () => Navigator.of(context).pushReplacementNamed(LoginScreen.routeName),
                      child: Text(
                        'Sign In',
