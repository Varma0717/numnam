<?php if(!request()->cookie('numnam_cookie_consent_v3')): ?>
<div class="cookie-consent" id="cookieConsent">
    <div class="cookie-consent-inner">
        <div class="cookie-consent-text">
            ...
            <p>We use cookies to enhance your experience. By continuing to browse, you agree to our <a href="<?php echo e(route('store.legal.cookie')); ?>">Cookie Policy</a>.</p>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\numnam-api\resources\views/store/partials/cookie-consent.blade.php ENDPATH**/ ?>