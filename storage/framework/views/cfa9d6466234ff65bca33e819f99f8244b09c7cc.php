...
<div class="footer-newsletter">
    <div class="footer-newsletter-inner">
        ...
        <form class="newsletter-form" method="POST" action="<?php echo e(route('store.contact.submit')); ?>">
            <?php echo csrf_field(); ?>
...
<footer class="site-footer">
    <div class="site-footer-inner">
        <div class="footer-col footer-brand-col">
            <!-- <div class="footer-logo">
                <img src="<?php echo e(asset('assets/images/Logo/TM_footer.png')); ?>" alt="NumNam logo" width="56" height="56" loading="lazy" class="brand-logo-img">
            </div> -->
            ...
            <div class="box-socials-footer">
                <a href="https://www.instagram.com/numnameats" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <a href="https://www.facebook.com/numnamofficial" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                    </svg>
                </a>
                <a href="https://www.linkedin.com/company/numnam" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="footer-col">
            <strong>Shop</strong>
            <a href="<?php echo e(route('store.products')); ?>">Products</a>
            <a href="<?php echo e(route('store.pricing')); ?>">Subscriptions</a>
            <a href="<?php echo e(route('store.refer-friends')); ?>">Refer Friends</a>
            <a href="<?php echo e(route('store.cart')); ?>">Cart</a>
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('store.checkout')); ?>">Checkout</a>
            <?php else: ?>
            <a href="<?php echo e(route('store.login')); ?>">Checkout</a>
            <?php endif; ?>
        </div>
        <div class="footer-col">
            ...
            <a href="<?php echo e(route('store.about')); ?>">About Us</a>
        </div>
        <div class="footer-col">
            <strong>Policies</strong>
            <a href="<?php echo e(route('store.legal.terms')); ?>">Terms & Conditions</a>
            <a href="<?php echo e(route('store.legal.privacy')); ?>">Privacy Policy</a>
            <a href="<?php echo e(route('store.legal.shipping')); ?>">Shipping Policy</a>
            <a href="<?php echo e(route('store.legal.refund')); ?>">Refund Policy</a>
            <a href="<?php echo e(route('store.legal.cookie')); ?>">Cookie Policy</a>
            <a href="<?php echo e(route('store.legal.payment-methods')); ?>">Payment Methods</a>
        </div>
        <div class="footer-col">
            <strong>Support</strong>
            <a href="<?php echo e(route('store.contact')); ?>">Contact Us</a>
            <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('store.account')); ?>">My Account</a>
            <?php else: ?>
            <a href="<?php echo e(route('store.login')); ?>">My Account</a>
            <?php endif; ?>
            <a href="<?php echo e(route('store.faq')); ?>">Help Center</a>
        </div>
    </div>
    ...
    <div class="footer-bottom">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> NumNam. All rights reserved. | Designed by <a href="https://pmratnam.com/" target="_blank" rel="noopener noreferrer" style="color:#FF6B8A;text-decoration:underline;">PMR Digital Marketing Agency</a></p>
    </div>
</footer><?php /**PATH C:\xampp\htdocs\numnam-api\resources\views/store/partials/footer.blade.php ENDPATH**/ ?>