...
<nav class="breadcrumbs" aria-label="Breadcrumb">
    <ol itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <?php if($crumb['url'] && $i < count($crumbs) - 1): ?>
                <a itemprop="item" href="<?php echo e($crumb['url']); ?>"><span itemprop="name"><?php echo e($crumb['label']); ?></span></a>
                <?php else: ?>
    ...
    <img src="<?php echo e(asset($kidsIllustrations['breadcrumb_buddy'] ?? 'assets/images/kids-icons/bird_2.png')); ?>" alt="" aria-hidden="true" class="breadcrumbs-buddy" loading="lazy">
</nav>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\numnam-api\resources\views/store/partials/breadcrumbs.blade.php ENDPATH**/ ?>