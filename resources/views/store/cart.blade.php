...
<section class="hero section in-view">
    <div class="relative overflow-hidden rounded-[2rem] border-3 bg-[#FFF0F5] px-6 py-10 sm:px-10 lg:px-12" style="border-color:#FFD6E5;">
        <div class="relative max-w-3xl">
            <span class="inline-flex w-fit rounded-full border-2 border-[#FFD93D] bg-white px-3 py-1 font-heading text-xs font-bold uppercase tracking-widest" style="color:#FF6B8A;">Cart</span>
            <h1 class="mt-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl" style="color:#2D2D3F;">Your selected products</h1>
            <p class="mt-3 text-base leading-relaxed" style="color:#5e6478;">Update quantity or proceed to checkout.</p>
        </div>
    </div>
</section>
