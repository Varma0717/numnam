...
<section class="admin-panel">
    ...
    <div class="admin-table-wrap">
        {{-- Bulk action form (standalone, not wrapping the table) --}}
        <form method="POST" action="{{ Route::has('admin.blogs.bulk') ? route('admin.blogs.bulk') : '#' }}" id="bulk-form">
            @csrf
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="check-column"><input type="checkbox" class="row-check" name="ids[]" value="{{ $blog->id }}" form="bulk-form"></td>
                    <td>{{ $blog->id }}</td>
