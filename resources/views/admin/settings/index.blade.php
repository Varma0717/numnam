        ...
        <div style="padding:16px;">
            ...
            <div class="admin-form-row">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <form method="POST" action="{{ route('admin.settings.destroy', $setting) }}" style="display:inline;" onsubmit="return confirm('Delete this setting?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="admin-btn-danger" style="font-size:11px;">Remove</button>
                    </form>
                </div>
